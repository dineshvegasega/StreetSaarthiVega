...
import com.vegasega.streetsaarthi.databinding.MembershipDetailsBinding
...
//                            viewModel.localOrganisation(view, JSONObject().apply {
...
//                        }
                    ...
                    data.local_organisation?.let {
                        ...
                        textAssociatedOrganizationVal.setText(data.local_organisation.name)
                    }


//                    viewModel.localOrganizationVendingTrue.observe(viewLifecycleOwner, Observer {
//                        if(it == true){
//                            data.local_organisation?.id?.let {
//                                for (item in viewModel.itemLocalOrganizationVending) {
//                                    if (item.id == data.local_organisation.id){
//                                        textAssociatedOrganizationVal.setText(data.local_organisation.name)
////                                    if (item.id == 7){
////                                        binding.textTypeofMarketPlaceValueTxt.setText(""+data.marketpalce_others)
////                                    } else {
